...
import { Eye, EyeOff, Loader2, Lock, Mail, Terminal, Cpu, Network, ShieldCheck, LogIn } from 'lucide-react'
...
export default function SignInPage() {
  ...
  return (
    <div 
      className="flex min-h-screen items-center justify-center p-4 md:p-8 bg-slate-50 text-slate-900 selection:bg-primary/30 relative overflow-hidden bg-cover bg-center font-sans"
    ...
    >
      ...
      {/* Glowing Orbs */}
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-[#BE2126]/10 rounded-full mix-blend-multiply filter blur-[100px] animate-pulse" />
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              <h1 className="text-3xl lg:text-4xl font-bold tracking-tight leading-tight text-slate-900">
                ...
                <span className="text-[#BE2126]">Next Generation</span>
              </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 text-slate-800">
                <div className="p-2.5 rounded-lg bg-white border border-slate-200 shadow-sm flex items-center justify-center">
                  <Network className="h-5 w-5 text-[#BE2126]" />
                </div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="space-y-1 relative">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full pl-9 pr-10 py-2 rounded-xl bg-white border text-sm transition-all focus:outline-none focus:ring-2 focus:ring-[#BE2126]/30",
                        errors.password ? "border-destructive" : "border-slate-200"
                      )}
                    />
                    <button
                      type="button"
                  ...
                  <a href="#" className="absolute right-0 -top-0.5 text-xs font-medium text-slate-500 hover:opacity-75">
                    Forgot password?
                  </a>
                </div>
                ...
                <button
                  ...
                  className="w-full py-2.5 mt-2 rounded-xl bg-[#BE2126] hover:bg-[#BE2126]/90 text-white font-semibold text-sm flex items-center justify-center gap-2 transition-all active:scale-98 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
