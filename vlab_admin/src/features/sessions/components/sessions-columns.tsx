...
// Helper function removed since usage columns are removed
        ...
        <div className="flex items-center gap-1.5 text-xs">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-muted-foreground">
              Since {start.toLocaleTimeString('en-IN', { timeZone: 'Asia/Kolkata', hour12: true, hour: '2-digit', minute:'2-digit' })}
            </span>
          </div>
        </div>
      )
